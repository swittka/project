...
\subsubsection{\textit{e} Units Configuring \emph{SystemVerilog} Components}
...
\paragraph{Configuring \emph{SystemVerilog} Components using objects}
...
(line~\ref{line_sv_declare_data}). This is because the configuration database only supports primitive data types as well
as the base type \lstinline$uvm_object$. So configuration objects need to be derived from this base type as shown in
