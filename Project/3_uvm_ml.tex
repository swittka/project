...
instead of an 32 bit one use \lstinline$--64bit$. If only the adapters for UVM-SystemVerilog and UVM-\textit{e} are
required, UVM-ML can be build without the SystemC adapter via \lstinline$--no_osci$.\\
